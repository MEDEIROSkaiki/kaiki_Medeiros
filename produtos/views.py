...
def lista_movimentacoes(request):
    # Busque todas as movimentações e use 'select_related' para
    # buscar os dados do usuário e do produto em uma única consulta.
    movimentacoes = MovimentacaoEstoque.objects.select_related('responsavel', 'produto').order_by('-data')
    
    context = {
        'movimentacoes': movimentacoes
    }
    # O nome do seu template pode ser diferente, como 'gestao_estoque.html'
    return render(request, 'lista_movimentacoes.html', context)